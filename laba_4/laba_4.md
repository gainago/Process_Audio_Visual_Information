...
| \(G\) (нормализованный) | Бинаризованный (\(T=50\)) |
|:-----------------------:|:-------------------------:|
| ![g](result/photo_g.png) | ![binary](result/photo_binary.png) |

---

### 4. Сравнение порогов бинаризации (дополнительно)

Для демонстрации влияния порога на результат можно получить бинарные изображения при различных значениях \(T\).  
*Примечание: для получения изображений с другими порогами достаточно изменить значение `threshold` в коде.*
