...
Скриншот был обработан с помощью Python (Pillow) для получения монохромного изображения(`result/monohrome_transparent.bmp`). Буквы чёрные.

| Исходное изображение |
|:--------------------:|
| ![Исходное изображение](result/monochrome_transparent.bmp) |
...
**Результаты:**
- По горизонтальному профилю выделены две строки(для 52 pt) текста.
