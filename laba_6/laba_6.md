...
В Libre Office была набрана романтическая фраза на алфавите Османья (шрифт Noto Sans Osmanya, кегль 52). Фраза состоит из двух строк:
...
Скриншот был обработан с помощью Python (Pillow) для получения монохромного изображения с прозрачным фоном (`result/monohrome_transparent.png`). Буквы чёрные, фон прозрачный.

| Исходное изображение |
|:--------------------:|
| ![Исходное изображение](result/monochrome_transparent.png) |
...
**Результаты:**
- По горизонтальному профилю выделены **две строки** текста.
- Для каждой строки по вертикальному профилю найдены границы отдельных символов.
- Выполнено прореживание: отсеяны блоки шириной менее 3 пикселей и высотой менее 5 пикселей (шум).
...
|:---------------------:|
| ![Сегментированное изображение](segmented_on_original.png) |
