...
#img_path = "to_parse.bmp"
img_path = "Alphabet_72.bmp"
...
output_path = "result/Alphabet_segmented_on_original_72.png"
img.save(output_path)
print(f"Сохранено: {output_path}")

with open("Alphabet_segmentation_coords_72.csv", "w") as f:
    f.write("x1;y1;x2;y2\n")
    for x1, y1, x2, y2 in all_chars:
